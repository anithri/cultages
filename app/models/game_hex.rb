...
#  game_map_id :bigint(8)        not null
#
# Indexes
#
#  index_game_hexes_on_game_map_id  (game_map_id)
#
# Foreign Keys
#
#  fk_rails_...  (game_map_id => game_maps.id)
#

class GameHex < ApplicationRecord
  NEIGHBORS   = [
    { q: 0, r: 1, s: -1 },
    { q: 1, r: 0, s: -1 },
    { q: 1, r: -1, s: 0 },
